...
| Runtime browser checks: rendered OG card, consent banner, focus visibility, SPA rendered DOM | `browser-use:control-browser` | Cheap | Drive the session browser per that skill's protocol; screenshots are evidence |
